          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/dashboard/citizen" className="hover:text-white">Citizen Portal</Link></li>
                <li><Link href="/dashboard/contractor" className="hover:text-white">Contractor Dashboard</Link></li>
